    ...
    return (
        <section id="contact" className="contact-section" ref={ref}>
            <div className="container">
                ...
                >
                    <a className="whatsapp" href="https://api.whatsapp.com/send/?phone=573182848957&text&type=phone_number&app_absent=0" target="_blank" aria-label="Contact me via WhatsApp">
                    ...
                    <a className="instagram" href="https://www.instagram.com/_andres.z_5/" target="_blank" aria-label="Contact me via Instagram">
                    ...
                    <a className="email" href="/" aria-label="Contact me via Email"
