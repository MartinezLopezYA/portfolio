...
import { Code, Server, Database, Palette, Star } from 'lucide-react';
    ...
    return (
        <section id="about" className="about-section" ref={ref}>
            <div className="container">
                ...
                >
                    I'm a Systems Engineer since 2024, and I find joy in developing new projects. When I discovered web development and its vast array of tools, I uncovered a true passion: providing and developing solutions that make a difference for people. I have experience with different languages, tools and frameworks.
                </motion.p>
